// Copyright (c) 2024, jignesh  and contributors
	...
	refresh: function (frm) {
		if (!frm.doc.__islocal) {
			frm.add_custom_button(__("Send Emails"), function () {
				...
				frappe.call({
					method: "frappe_ats.frappe_ats.doctype.custom_process_statement_of_account.custom_process_statement_of_account.send_emails",
					args: {
			...
			frm.add_custom_button(__("Download"), function () {
				...
				let url = frappe.urllib.get_full_url(
					"/api/method/frappe_ats.frappe_ats.doctype.custom_process_statement_of_account.custom_process_statement_of_account.download_statements?" +
						"document_name=" +
...
frappe.ui.form.on("Custom Process Statement Of Account", {
	customer: function (frm, cdt, cdn) {
		...
		frappe.call({
			method: "frappe_ats.frappe_ats.doctype.custom_process_statement_of_account.custom_process_statement_of_account.get_customer_emails",
			args: {
